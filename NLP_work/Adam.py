...
class CustomAdam(Optimizer):
    ...
    def __init__(self, params, stepsize = 0.02, bias_m1=0.9, bias_m2=0.999, epsilon=10e-8, bias_correction=True):
        ...
        if bias_m1 < 0 or bias_m2 < 0 and bias_correction:
            raise ValueError(
                "Invalid bias parameters [{}, {}]. Choose positive bias parameters.".format(bias_m1, bias_m2))
